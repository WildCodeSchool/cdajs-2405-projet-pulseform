...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'AuthPayload', user: { __typename?: 'User', id: string, username: string, email: string } } };

export type GetAllProgramsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllProgramsQuery = { __typename?: 'Query', getAllPrograms: Array<{ __typename?: 'Program', id: string, name: string, description?: string | null, image?: string | null, total_duration?: number | null, level: FitnessLevel, created_at: Date, visibility: number, like?: number | null, exercises?: Array<{ __typename?: 'Exercise', id: string, name: string, description?: string | null, duration: number, kcal_loss: number, muscle: MuscleGroup, level: FitnessLevel, img_src?: string | null }> | null, tags?: Array<{ __typename?: 'Tag', id: string, name: Tags }> | null }> };
...
export type GetProgramByIdQuery = { __typename?: 'Query', getProgramById?: { __typename?: 'Program', id: string, name: string, description?: string | null, image?: string | null, created_at: Date, tags?: Array<{ __typename?: 'Tag', id: string, name: Tags }> | null } | null };

export type MeQueryVariables = Exact<{ [key: string]: never; }>;


export type MeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, email: string, role: MemberRole } | null };
...
export type GetUserByIdQuery = { __typename?: 'Query', getUserById?: { __typename?: 'User', id: string, username: string, description: string, email: string, image?: string | null, birthday?: Date | null, gender?: string | null, height?: number | null, created_at: Date, role: MemberRole, level?: FitnessLevel | null } | null };

export type GetAllUsersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllUsersQuery = { __typename?: 'Query', getAllUsers: Array<{ __typename?: 'User', id: string, username: string, description: string, email: string, image?: string | null, birthday?: Date | null, gender?: string | null, height?: number | null, created_at: Date, role: MemberRole, level?: FitnessLevel | null }> };
...
export type GetWeightByUserIdQuery = { __typename?: 'Query', getWeightByUserId: Array<{ __typename?: 'Weight', month: string, update_at: Date, weight: number }> };
 ...
 * });
 */
export function useGetAllProgramsQuery(baseOptions?: Apollo.QueryHookOptions<GetAllProgramsQuery, GetAllProgramsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllProgramsQuery, GetAllProgramsQueryVariables>(GetAllProgramsDocument, options);
      }
export function useGetAllProgramsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllProgramsQuery, GetAllProgramsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllProgramsQuery, GetAllProgramsQueryVariables>(GetAllProgramsDocument, options);
        }
export function useGetAllProgramsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAllProgramsQuery, GetAllProgramsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllProgramsQuery, GetAllProgramsQueryVariables>(GetAllProgramsDocument, options);
        }
...
export type GetAllProgramsSuspenseQueryHookResult = ReturnType<typeof useGetAllProgramsSuspenseQuery>;
export type GetAllProgramsQueryResult = Apollo.QueryResult<GetAllProgramsQuery, GetAllProgramsQueryVariables>;
 ...
 * });
 */
export function useGetProgramByIdQuery(baseOptions: Apollo.QueryHookOptions<GetProgramByIdQuery, GetProgramByIdQueryVariables> & ({ variables: GetProgramByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProgramByIdQuery, GetProgramByIdQueryVariables>(GetProgramByIdDocument, options);
      }
export function useGetProgramByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProgramByIdQuery, GetProgramByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProgramByIdQuery, GetProgramByIdQueryVariables>(GetProgramByIdDocument, options);
        }
export function useGetProgramByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetProgramByIdQuery, GetProgramByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetProgramByIdQuery, GetProgramByIdQueryVariables>(GetProgramByIdDocument, options);
        }
export type GetProgramByIdQueryHookResult = ReturnType<typeof useGetProgramByIdQuery>;
export type GetProgramByIdLazyQueryHookResult = ReturnType<typeof useGetProgramByIdLazyQuery>;
export type GetProgramByIdSuspenseQueryHookResult = ReturnType<typeof useGetProgramByIdSuspenseQuery>;
export type GetProgramByIdQueryResult = Apollo.QueryResult<GetProgramByIdQuery, GetProgramByIdQueryVariables>;
 ...
 * });
 */
export function useGetWeightByUserIdQuery(baseOptions: Apollo.QueryHookOptions<GetWeightByUserIdQuery, GetWeightByUserIdQueryVariables> & ({ variables: GetWeightByUserIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetWeightByUserIdQuery, GetWeightByUserIdQueryVariables>(GetWeightByUserIdDocument, options);
      }
export function useGetWeightByUserIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetWeightByUserIdQuery, GetWeightByUserIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetWeightByUserIdQuery, GetWeightByUserIdQueryVariables>(GetWeightByUserIdDocument, options);
        }
export function useGetWeightByUserIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetWeightByUserIdQuery, GetWeightByUserIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetWeightByUserIdQuery, GetWeightByUserIdQueryVariables>(GetWeightByUserIdDocument, options);
        }
export type GetWeightByUserIdQueryHookResult = ReturnType<typeof useGetWeightByUserIdQuery>;
export type GetWeightByUserIdLazyQueryHookResult = ReturnType<typeof useGetWeightByUserIdLazyQuery>;
export type GetWeightByUserIdSuspenseQueryHookResult = ReturnType<typeof useGetWeightByUserIdSuspenseQuery>;
export type GetWeightByUserIdQueryResult = Apollo.QueryResult<GetWeightByUserIdQuery, GetWeightByUserIdQueryVariables>;