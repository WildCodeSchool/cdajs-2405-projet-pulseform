...
async function seed() {
  try {
    ...
    await client.query(`
      ...
      (1, 'Gael', 'Un utilisateur actif', 'prigentgael@gmail.com', '$argon2id$v=19$m=65536,t=3,p=4$OHtdXCMWGkZy9+AbeqFZKg$kBxbFprdFOMAr5NG8+tM4sQIgYUXEMykASFqX9JjK5s', 'profile1.jpg', '1990-01-15', 'M', 75, 180, NOW(), 'admin', 'advanced'),
